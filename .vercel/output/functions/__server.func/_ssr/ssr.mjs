...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DvP6WYvR.mjs");
...
var manifest = { "d1c6d03b77ee5b3bacd834c22570e5cf35c63a8348fc4c26d28f3dd3243d4c8a": {
	functionName: "narrateMatch_createServerFn_handler",
	importer: () => import("./narrate-CkhswZ4R.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-G7fHBEkz.mjs").then((n) => n.t),
